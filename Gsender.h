...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "ZGF2aWRtdXNzZXJAZ21haWwuY29t";
        const char* EMAILBASE64_PASSWORD = "bGloYyBlY2VmIGViZHkgZXh5eQ==";
        const char* FROM = "davidmusser@gmail.com";
